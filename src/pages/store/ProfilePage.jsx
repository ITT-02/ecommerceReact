...
import {
  ...
  useMediaQuery, Container, Stack, Alert // <-- CORREGIDO: Importado Alert
} from '@mui/material';
...
import { ProfileForm }   from '../../pages/store/profile/components/ProfileForm';
import { AddressCard }   from '../../pages/store/profile/components/AddressCard';
import { AddressDialog } from '../../pages/store/profile/components/AddressDialog';
...
export const ProfilePage = () => {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 3, md: 5 }, px: { lg: 5 } }}>
      <Stack spacing={3}>
        <Box>
          <Typography variant="overline" color="primary.main">Cuenta</Typography>
          <Typography variant="h2" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' } }}>Mi perfil</Typography>
          <Typography variant="body2" color="text.secondary">Actualiza tus datos y direcciones para checkout.</Typography>
        </Box>

        {/*Control preventivo para evitar caídas si error/notice no traen texto */}
        ...
        <Box sx={{
          display: 'grid',
          gridTemplateColumns: { xs: '1fr', md: '280px 1fr' }, // <-- MEJORA: Subido a 280px para mejor proporción
          gap: { xs: 2, md: 3, lg: 4 },
          alignItems: 'start',
        }}>
